    ...
    <footer className="border-t bg-slate-50">
      <div className="container-page py-12">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mb-4 text-sm text-slate-600">
              Han Store là cửa hàng thời trang trực tuyến chuyên cung cấp các
              sản phẩm quần áo, phụ kiện và đồ gia dụng chất lượng cao với giá
              cả hợp lý.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/" className="text-slate-600 hover:text-accent">
                  Trang chủ
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/blog" className="text-slate-600 hover:text-accent">
                  Blog
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-slate-600 hover:text-accent">
                  Giới thiệu
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-600">
              ...
              <li className="flex items-center gap-2">
                ...
                <a
                  href="mailto:support@hanstore.com"
                  className="hover:text-accent"
                >
                  support@hanstore.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-8 border-t border-slate-200 pt-8 text-center text-sm text-slate-600">
          <p>
            © {currentYear} Han Store. Tất cả quyền được bảo lưu.
          </p>
        </div>
      </div>
    </footer>
